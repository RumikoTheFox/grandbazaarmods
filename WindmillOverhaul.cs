...
public class Plugin : BasePlugin
{
    ...
    public override void Load()
    {
        ...
        RedQuality = Config.Bind("--------08 RED WONDERSTONE BUFF--------", "Red Stone Quality Increase",1.0f, 
            "Set the quality increase for making crops into seeds when done with a Red Wonderstone. Game Default: 1.0");
        BlueTime = Config.Bind("--------09 BLUE WONDERSTONE BUFF--------", "Blue Stone Craft Multiplier",0.5f, 
            "Set the Blue Wonderstone's crafting time multiplier. Lower number means faster. Game Default: 0.5");
        AllRecipes = Config.Bind("--------01 ALL RECIPES--------", "All Recipes Enabled", false,
            "Set to true to unlock all recipes in all windmills.");
        ModifiedWindscreen = Config.Bind("--------02 WINDSCREEN COST--------", "Cheaper Windscreen Recipe", false,
            "Set to true to enable cheaper Windscreen Kit crafting.");
        WindscreenCost = Config.Bind("--------02 WINDSCREEN COST--------", "Windscreen Material Cost", 5,
            "Set to the amount each of wood and rocks you want the Windscreen Kit to cost.");
        ModifiedMaterials = Config.Bind("--------03 LUMBER/STONE COST--------", "Modified Material Recipes", false,
            "Set to true to enable modified Lumber/Stone crafting.");
        ForStone = Config.Bind("--------03 LUMBER/STONE COST--------", "Stone Cost", 5,
            "Set the amount of rocks required for this recipe. Balanced: 5. Half Cost: 3.");
        ForSturdyStone = Config.Bind("--------03 LUMBER/STONE COST--------", "Sturdy Stone Cost", 25,
            "Set the amount of rocks required for this recipe. Balanced: 25. Half Cost: 12.");
        ForUltimateStone = Config.Bind("--------03 LUMBER/STONE COST--------", "Ultimate Stone Cost", 125,
            "Set the amount of rocks required for this recipe. Balanced: 125. Half Cost: 60.");
        ForLumber = Config.Bind("--------03 LUMBER/STONE COST--------", "Lumber Cost", 5,
            "Set the amount of wood required for this recipe. Balanced: 5. Half Cost: 3.");
        ForSturdyLumber = Config.Bind("--------03 LUMBER/STONE COST--------", "Sturdy Lumber Cost", 25,
            "Set the amount of wood required for this recipe. Balanced: 25. Half Cost: 12.");
        ForUltimateLumber = Config.Bind("--------03 LUMBER/STONE COST--------", "Ultimate Lumber Cost", 125,
            "Set the amount of wood required for this recipe. Balanced: 125. Half Cost: 60.");
        CheaperRecipesToggle = Config.Bind("--------04 CHEAPER RECIPES--------", "All Crafting Cheap", false,
        ...
        CheaperRecipeItem = Config.Bind("--------04 CHEAPER RECIPES--------", "Material Item", 110500,
        ...
        CraftTimeToggle = Config.Bind("--------11 BASE CRAFTING TIME--------", "Change Base Craft Time", false,
            "Set to true to set the base craft time for all recipes at once.");
        CraftTime = Config.Bind("--------11 BASE CRAFTING TIME--------", "Base Crafting Time", 0,
        ...
        HiddenItems = Config.Bind("--------10 SHOW HIDDEN RECIPES--------", "Show Hidden Recipes", false,
